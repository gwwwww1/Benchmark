...
def evaluate(model, dataloader, device,model_id='clip' ,amp=True, recall_k_list=[1, 3, 5]):
    """
    ...
    print(images_emb.device, image_labels.device)
    ...
    return metrics,images_emb.to('cpu'),image_labels.to('cpu')
